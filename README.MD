[![Build Status](https://travis-ci.org/Orange-OpenSource/spring-security-formlogin-restbasic?branch=master)](https://travis-ci.org/Orange-OpenSource/spring-security-formlogin-restbasic) 
